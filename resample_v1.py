...
test[1:test.shape[0]:2, 1:test.shape[1]:2] = test[0:test.shape[0]-1:2, 0:test.shape[1]-1:2].values +  test[1:test.shape[0]:2, 1:test.shape[1]:2].values # down + right
test[0:test.shape[0]:2 , 1:test.shape[1]:2] = test[0:test.shape[0]:2, 0:test.shape[1]-1:2].values +  test[0:test.shape[0]:2 , 1:test.shape[1]:2].values # right
...
# scaleing up the test from above
tp_merge = tp_merge.fillna(0)
tp_merge[:, 1:tp_merge.shape[1], :] = tp_merge[:, 0:tp_merge.shape[1]-1,:].values +  tp_merge[:, 1:tp_merge.shape[1], :].values # down
tp_merge[:, 1:tp_merge.shape[1]:2, 1:tp_merge.shape[2]:2] = tp_merge[:, 0:tp_merge.shape[1]-1:2, 0:tp_merge.shape[2]-1:2].values +  tp_merge[:, 1:tp_merge.shape[1]:2, 1:tp_merge.shape[2]:2].values # down + right
tp_merge[:, 0:tp_merge.shape[1]:2 , 1:tp_merge.shape[2]:2] = tp_merge[:, 0:tp_merge.shape[1]:2, 0:tp_merge.shape[2]-1:2].values +  tp_merge[:, 0:tp_merge.shape[1]:2 , 1:tp_merge.shape[2]:2].values # right
...
tp_merge.to_netcdf('test.nc','w','NETCDF4', engine= 'netcdf4')
